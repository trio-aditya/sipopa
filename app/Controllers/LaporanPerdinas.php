...
use App\Models\LaporanCobaModel;
...
class LaporanPerdinas extends BaseController
{
    ...
    protected $laporanCobaModel;
    protected $laporanFilterModel;

    public function __construct()
    {
        $this->laporanModel = new LaporanModel();
        $this->laporanCobaModel = new LaporanCobaModel();
    ...
    public function excel_filter()
    {
        ...
        $data = [
            ...
            'sum_target1' => $this->laporanFilterModel->sumTarget1(),
            // Menampilkan semua data opd 1
            'laporan_perdinas1' => $this->laporanFilterModel->getData1($bl_tanggal_awal, $bl_tanggal_akhir),
            //Realisasi bulan lalu dengan jenis pajak 1 dan opd 1
            'sum_realisasi' => $this->laporanFilterModel->sumRealisasi($bl_tanggal_awal, $bl_tanggal_akhir),
            //Realisasi bulan ini dengan jenis pajak 1 dan opd 1
            'sum_realisasi2' => $this->laporanFilterModel->sumRealisasi2($tanggal_awal, $tanggal_akhir),
            //Menampilkan bulan ini
            // 'bulan_lalu' => $this->laporanFilterModel->bulan_lalu($tanggal_awal, $tanggal_akhir),
            // ===========================================================================================
            // Keseluruhan jumlah Retribusi
            'jenis_pendapatan2' => $this->laporanFilterModel->getJenis2(),
            // Target Dinas Kesehatan
            'sum_target2' => $this->laporanFilterModel->sumTarget2(),
            // Realisasi bulan lalu dengan jenis pajak 2 dan opd 2
            'sum_realisasi3' => $this->laporanFilterModel->sumRealisasi3($bl_tanggal_awal, $bl_tanggal_akhir),
            // Realisasi bulan ini dengan jenis pajak 2 dan opd 2
            'sum_realisasi4' => $this->laporanFilterModel->sumRealisasi4($tanggal_awal, $tanggal_akhir),
            // Menampilkan semua data opd 2
            'laporan_perdinas2' => $this->laporanFilterModel->getData2($bl_tanggal_awal, $bl_tanggal_akhir),

            // Keseluruhan data jenis pajak 2 dan opd 3
            'jenis_pendapatan3' => $this->laporanFilterModel->getJenis3(),
            // Target opd jenis pajak 2 dan opd 3
            'sum_target3' => $this->laporanFilterModel->sumTarget3(),
            //Realisasi bulan lalu dengan jenis pajak 2 dan opd 3
            'sum_realisasi5' => $this->laporanFilterModel->sumRealisasi5($bl_tanggal_awal, $bl_tanggal_akhir),
            //Realisasi bulan ini dengan jenis pajak 2 dan opd 3
            'sum_realisasi6' => $this->laporanFilterModel->sumRealisasi6($tanggal_awal, $tanggal_akhir),
            // Menampilkan semua data jenis pajak 2 dan opd 3
            'laporan_perdinas3' => $this->laporanFilterModel->getData3($bl_tanggal_awal, $bl_tanggal_akhir),

            // Keseluruhan data jenis pajak 2 dan opd 4
            'jenis_pendapatan4' => $this->laporanFilterModel->getJenis4(),
            // Target opd jenis pajak 2 dan opd 4
            'sum_target4' => $this->laporanFilterModel->sumTarget4(),
            //Realisasi bulan lalu dengan jenis pajak 2 dan opd 4
            'sum_realisasi7' => $this->laporanFilterModel->sumRealisasi7($bl_tanggal_awal, $bl_tanggal_akhir),
            //Realisasi bulan ini dengan jenis pajak 2 dan opd 4
            'sum_realisasi8' => $this->laporanFilterModel->sumRealisasi8($tanggal_awal, $tanggal_akhir),
            // Menampilkan semua data jenis pajak 2 dan opd 4
            'laporan_perdinas4' => $this->laporanFilterModel->getData4($bl_tanggal_awal, $bl_tanggal_akhir),

            // Keseluruhan data jenis pajak 2 dan opd 5
            'jenis_pendapatan5' => $this->laporanFilterModel->getJenis5(),
            // Target opd jenis pajak 2 dan opd 5
            'sum_target5' => $this->laporanFilterModel->sumTarget5(),
            //Realisasi bulan lalu dengan jenis pajak 2 dan opd 5
            'sum_realisasi9' => $this->laporanFilterModel->sumRealisasi9($bl_tanggal_awal, $bl_tanggal_akhir),
            //Realisasi bulan ini dengan jenis pajak 2 dan opd 5
            'sum_realisasi10' => $this->laporanFilterModel->sumRealisasi10($tanggal_awal, $tanggal_akhir),
            // Menampilkan semua data jenis pajak 2 dan opd 5
            'laporan_perdinas5' => $this->laporanFilterModel->getData5($bl_tanggal_awal, $bl_tanggal_akhir),

            // Keseluruhan data jenis pajak 2 dan opd 6
            'jenis_pendapatan6' => $this->laporanFilterModel->getJenis6(),
            // Target opd jenis pajak 2 dan opd 6
            'sum_target6' => $this->laporanFilterModel->sumTarget6(),
            //Realisasi bulan lalu dengan jenis pajak 2 dan opd 6
            'sum_realisasi11' => $this->laporanFilterModel->sumRealisasi11($bl_tanggal_awal, $bl_tanggal_akhir),
            //Realisasi bulan ini dengan jenis pajak 2 dan opd 6
            'sum_realisasi12' => $this->laporanFilterModel->sumRealisasi12($tanggal_awal, $tanggal_akhir),
            // Menampilkan semua data jenis pajak 2 dan opd 6
            'laporan_perdinas6' => $this->laporanFilterModel->getData6($bl_tanggal_awal, $bl_tanggal_akhir),
            ...
            'sum_target7' => $this->laporanFilterModel->sumTarget7(),
            //Realisasi dengan jenis pajak 2 dan opd 7
            'sum_realisasi13' => $this->laporanFilterModel->sumRealisasi13($bl_tanggal_awal, $bl_tanggal_akhir),
            'sum_realisasi14' => $this->laporanFilterModel->sumRealisasi14($tanggal_awal, $tanggal_akhir),
            // Menampilkan semua data jenis pajak 2 dan opd 7
            'laporan_perdinas7' => $this->laporanFilterModel->getData7($bl_tanggal_awal, $bl_tanggal_akhir),
            ...
            // Target opd jenis pajak 2 dan opd 8
            'sum_target8' => $this->laporanFilterModel->sumTarget8(),
            //Realisasi bulan lalu dengan jenis pajak 2 dan opd 8
            'sum_realisasi15' => $this->laporanFilterModel->sumRealisasi15($bl_tanggal_awal, $bl_tanggal_akhir),
            //Realisasi bulan ini dengan jenis pajak 2 dan opd 8
            'sum_realisasi16' => $this->laporanFilterModel->sumRealisasi16($tanggal_awal, $tanggal_akhir),
            // Menampilkan semua data jenis pajak 2 dan opd 8
            'laporan_perdinas8' => $this->laporanFilterModel->getData8($bl_tanggal_awal, $bl_tanggal_akhir),

            // Keseluruhan data jenis pajak 2 dan opd 9
            'jenis_pendapatan9' => $this->laporanFilterModel->getJenis9(),
            // Target opd jenis pajak 2 dan opd 9
            'sum_target9' => $this->laporanFilterModel->sumTarget9(),
            //Realisasi bulan lalu dengan jenis pajak 2 dan opd 9
            'sum_realisasi17' => $this->laporanFilterModel->sumRealisasi17($bl_tanggal_awal, $bl_tanggal_akhir),
            //Realisasi bulan ini dengan jenis pajak 2 dan opd 9
            'sum_realisasi18' => $this->laporanFilterModel->sumRealisasi18($tanggal_awal, $tanggal_akhir),
            // Menampilkan semua data jenis pajak 2 dan opd 9
            'laporan_perdinas9' => $this->laporanFilterModel->getData9($bl_tanggal_awal, $bl_tanggal_akhir),
            ...
            // Target opd jenis pajak 2 dan opd 10
            'sum_target10' => $this->laporanFilterModel->sumTarget10(),
            //Realisasi bulan lalu dengan jenis pajak 2 dan opd 10
            'sum_realisasi19' => $this->laporanFilterModel->sumRealisasi19($bl_tanggal_awal, $bl_tanggal_akhir),
            //Realisasi bulan ini dengan jenis pajak 2 dan opd 10
            'sum_realisasi20' => $this->laporanFilterModel->sumRealisasi20($tanggal_awal, $tanggal_akhir),
            // Menampilkan semua data jenis pajak 2 dan opd 10
            'laporan_perdinas10' => $this->laporanFilterModel->getData10($bl_tanggal_awal, $bl_tanggal_akhir),
            ...
            'sum_target11' => $this->laporanFilterModel->sumTarget11(),
            //Realisasi dengan jenis pajak 2 dan opd 11
            'sum_realisasi21' => $this->laporanFilterModel->sumRealisasi21($bl_tanggal_awal, $bl_tanggal_akhir),
            'sum_realisasi22' => $this->laporanFilterModel->sumRealisasi22($tanggal_awal, $tanggal_akhir),
            // Menampilkan semua data jenis pajak 2 dan opd 11
            'laporan_perdinas11' => $this->laporanFilterModel->getData11($bl_tanggal_awal, $bl_tanggal_akhir),
            ...
            // Target opd jenis pajak 2 dan opd 12
            'sum_target12' => $this->laporanFilterModel->sumTarget12(),
            //Realisasi bulan lalu dengan jenis pajak 2 dan opd 12
            'sum_realisasi23' => $this->laporanFilterModel->sumRealisasi23($bl_tanggal_awal, $bl_tanggal_akhir),
            //Realisasi bulan ini dengan jenis pajak 2 dan opd 12
            'sum_realisasi24' => $this->laporanFilterModel->sumRealisasi24($tanggal_awal, $tanggal_akhir),
            // Menampilkan semua data jenis pajak 2 dan opd 12
            'laporan_perdinas12' => $this->laporanFilterModel->getData12($bl_tanggal_awal, $bl_tanggal_akhir),
            // ===========================================================================================
            // HASIL PENGELOLAAN KEKAYAAN DAERAH YANG DIPISAHKAN
            // Keseluruhan data jenis pajak 3 dan opd 13
            'jenis_pendapatan13' => $this->laporanFilterModel->getJenis13(),
            // Target opd jenis pajak 3 dan opd 13
            'sum_target13' => $this->laporanFilterModel->sumTarget13(),
            //Realisasi bulan lalu dengan jenis pajak 3 dan opd 13
            'sum_realisasi25' => $this->laporanFilterModel->sumRealisasi25($bl_tanggal_awal, $bl_tanggal_akhir),
            //Realisasi bulan ini dengan jenis pajak 3 dan opd 13
            'sum_realisasi26' => $this->laporanFilterModel->sumRealisasi26($tanggal_awal, $tanggal_akhir),
            // Menampilkan semua data jenis pajak 3 dan opd 13
            'laporan_perdinas13' => $this->laporanFilterModel->getData13($bl_tanggal_awal, $bl_tanggal_akhir),

            // Keseluruhan data jenis pajak 3 dan opd 12
            'jenis_pendapatan14' => $this->laporanFilterModel->getJenis14(),
            // Target opd jenis pajak 3 dan opd 12
            'sum_target14' => $this->laporanFilterModel->sumTarget14(),
            //Realisasi bulan lalu dengan jenis pajak 3 dan opd 14
            'sum_realisasi27' => $this->laporanFilterModel->sumRealisasi27($bl_tanggal_awal, $bl_tanggal_akhir),
            //Realisasi bulan ini dengan jenis pajak 3 dan opd 14
            'sum_realisasi28' => $this->laporanFilterModel->sumRealisasi28($tanggal_awal, $tanggal_akhir),
            // Menampilkan semua data jenis pajak 3 dan opd 12
            'laporan_perdinas14' => $this->laporanFilterModel->getData14($bl_tanggal_awal, $bl_tanggal_akhir),
            // ===========================================================================================
            // LAIN-LAIN PAD YANG SAH
            // Keseluruhan data jenis pajak 4 dan opd 1
            'jenis_pendapatan15' => $this->laporanFilterModel->getJenis15(),
            // Target opd jenis pajak 4 dan opd 1
            'sum_target15' => $this->laporanFilterModel->sumTarget15(),
            //Realisasi bulan lalu dengan jenis pajak 4 dan opd 1
            'sum_realisasi29' => $this->laporanFilterModel->sumRealisasi29($bl_tanggal_awal, $bl_tanggal_akhir),
            //Realisasi bulan ini dengan jenis pajak 4 dan opd 1
            'sum_realisasi30' => $this->laporanFilterModel->sumRealisasi30($tanggal_awal, $tanggal_akhir),
            // Menampilkan semua data jenis pajak 4 dan opd 1
            'laporan_perdinas15' => $this->laporanFilterModel->getData15($bl_tanggal_awal, $bl_tanggal_akhir),
            ...
            // Target opd jenis pajak 4 dan opd 14
            'sum_target16' => $this->laporanFilterModel->sumTarget16(),
            //Realisasi bulan lalu dengan jenis pajak 4 dan opd 14
            'sum_realisasi31' => $this->laporanFilterModel->sumRealisasi31($bl_tanggal_awal, $bl_tanggal_akhir),
            //Realisasi bulan ini dengan jenis pajak 4 dan opd 14
            'sum_realisasi32' => $this->laporanFilterModel->sumRealisasi32($tanggal_awal, $tanggal_akhir),
            // Menampilkan semua data jenis pajak 4 dan opd 14
            'laporan_perdinas16' => $this->laporanFilterModel->getData16($bl_tanggal_awal, $bl_tanggal_akhir),

            // Keseluruhan data jenis pajak 4 dan opd 15
            'jenis_pendapatan17' => $this->laporanFilterModel->getJenis17(),
            // Target opd jenis pajak 4 dan opd 15
            'sum_target17' => $this->laporanFilterModel->sumTarget17(),
            //Realisasi bulan lalu dengan jenis pajak 4 dan opd 15
            'sum_realisasi33' => $this->laporanFilterModel->sumRealisasi33($bl_tanggal_awal, $bl_tanggal_akhir),
            //Realisasi bulan ini dengan jenis pajak 4 dan opd 15
            'sum_realisasi34' => $this->laporanFilterModel->sumRealisasi34($tanggal_awal, $tanggal_akhir),
            // Menampilkan semua data jenis pajak 4 dan opd 15
            'laporan_perdinas17' => $this->laporanFilterModel->getData17($bl_tanggal_awal, $bl_tanggal_akhir),
            ...
            // Target opd jenis pajak 4 dan opd 2
            'sum_target18' => $this->laporanFilterModel->sumTarget18(),
            //Realisasi bulan lalu dengan jenis pajak 4 dan opd 2
            'sum_realisasi35' => $this->laporanFilterModel->sumRealisasi35($bl_tanggal_awal, $bl_tanggal_akhir),
            //Realisasi bulan ini dengan jenis pajak 4 dan opd 2
            'sum_realisasi36' => $this->laporanFilterModel->sumRealisasi36($tanggal_awal, $tanggal_akhir),
            // Menampilkan semua data jenis pajak 4 dan opd 2
            'laporan_perdinas18' => $this->laporanFilterModel->getData18($bl_tanggal_awal, $bl_tanggal_akhir),

            // Keseluruhan data jenis pajak 4 dan opd 16
            'jenis_pendapatan19' => $this->laporanFilterModel->getJenis19(),
            // Target opd jenis pajak 4 dan opd 16
            'sum_target19' => $this->laporanFilterModel->sumTarget19(),
            //Realisasi bulan lalu dengan jenis pajak 4 dan opd 16
            'sum_realisasi37' => $this->laporanFilterModel->sumRealisasi37($bl_tanggal_awal, $bl_tanggal_akhir),
            //Realisasi bulan ini dengan jenis pajak 4 dan opd 16
            'sum_realisasi38' => $this->laporanFilterModel->sumRealisasi38($tanggal_awal, $tanggal_akhir),
            // Menampilkan semua data jenis pajak 4 dan opd 16
            'laporan_perdinas19' => $this->laporanFilterModel->getData19($bl_tanggal_awal, $bl_tanggal_akhir),
            ...
            // Target opd jenis pajak 4 dan opd 13
            'sum_target20' => $this->laporanFilterModel->sumTarget20(),
            //Realisasi bulan lalu dengan jenis pajak 4 dan opd 13
            'sum_realisasi39' => $this->laporanFilterModel->sumRealisasi39($bl_tanggal_awal, $bl_tanggal_akhir),
            //Realisasi bulan ini dengan jenis pajak 4 dan opd 13
            'sum_realisasi40' => $this->laporanFilterModel->sumRealisasi40($tanggal_awal, $tanggal_akhir),
            // Menampilkan semua data jenis pajak 4 dan opd 13
            'laporan_perdinas20' => $this->laporanFilterModel->getData20($bl_tanggal_awal, $bl_tanggal_akhir),
            // ===========================================================================================
            // PENDAPATAN TRANSFER
            'jenis_pendapatan5101' => $this->laporanFilterModel->getJenis5101(),
            // PENDAPATAN TRANSFER
            ...
            'sum_target5101' => $this->laporanFilterModel->sumTarget5101(),
            //Realisasi dengan jenis pajak 5 dan opd 1
            'sum_realisasi5101' => $this->laporanFilterModel->sumRealisasi5101($bl_tanggal_awal, $bl_tanggal_akhir),
            'bsum_realisasi5101' => $this->laporanFilterModel->bsumRealisasi5101($tanggal_awal, $tanggal_akhir),
            // Menampilkan semua data jenis pajak 5 dan opd 1
            'laporan_perdinas5101' => $this->laporanFilterModel->getData5101($bl_tanggal_awal, $bl_tanggal_akhir),

            // kode 0102
            //Menampilkan Target
            'sum_target5102' => $this->laporanFilterModel->sumTarget5102(),
            //Menampilkan realisasi bulan lalu
            'sum_realisasi5102' => $this->laporanFilterModel->sumRealisasi5102($bl_tanggal_awal, $bl_tanggal_akhir),
            //Menampilkan realisasi bulan ini
            'bsum_realisasi5102' => $this->laporanFilterModel->bsumRealisasi5102($tanggal_awal, $tanggal_akhir),
            // Menampilkan semua data jenis pajak 5 dan opd 1
            'laporan_perdinas5102' => $this->laporanFilterModel->getData5102($bl_tanggal_awal, $bl_tanggal_akhir),

            // kode 0103
            //Menampilkan Target
            'sum_target5103' => $this->laporanFilterModel->sumTarget5103(),
            //Menampilkan realisasi bulan lalu
            'sum_realisasi5103' => $this->laporanFilterModel->sumRealisasi5103($bl_tanggal_awal, $bl_tanggal_akhir),
            //Menampilkan realisasi bulan ini
            'bsum_realisasi5103' => $this->laporanFilterModel->bsumRealisasi5103($tanggal_awal, $tanggal_akhir),
            // Menampilkan semua data jenis pajak 5 dan opd 1
            'laporan_perdinas5103' => $this->laporanFilterModel->getData5103($bl_tanggal_awal, $bl_tanggal_akhir),

            // kode 0104
            //Menampilkan Target
            'sum_target5104' => $this->laporanFilterModel->sumTarget5104(),
            //Menampilkan realisasi bulan lalu
            'sum_realisasi5104' => $this->laporanFilterModel->sumRealisasi5104($bl_tanggal_awal, $bl_tanggal_akhir),
            //Menampilkan realisasi bulan ini
            'bsum_realisasi5104' => $this->laporanFilterModel->bsumRealisasi5104($tanggal_awal, $tanggal_akhir),
            // Menampilkan semua data jenis pajak 5 dan opd 1
            'laporan_perdinas5104' => $this->laporanFilterModel->getData5104($bl_tanggal_awal, $bl_tanggal_akhir),
            ...
            'sum_target512' => $this->laporanFilterModel->sumTarget512(),
            //Menampilkan realisasi
            'sum_realisasi512' => $this->laporanFilterModel->sumRealisasi512($bl_tanggal_awal, $bl_tanggal_akhir),
            'bsum_realisasi512' => $this->laporanFilterModel->bsumRealisasi512($tanggal_awal, $tanggal_akhir),
            'laporan_perdinas512' => $this->laporanFilterModel->getData512($bl_tanggal_awal, $bl_tanggal_akhir),

            // kode 05
            //Menampilkan Target
            'sum_target515' => $this->laporanFilterModel->sumTarget515(),
            //Menampilkan realisasi bulan ini
            'sum_realisasi515' => $this->laporanFilterModel->sumRealisasi515($bl_tanggal_awal, $bl_tanggal_akhir),
            'bsum_realisasi515' => $this->laporanFilterModel->bsumRealisasi515($tanggal_awal, $tanggal_akhir),
            'laporan_perdinas515' => $this->laporanFilterModel->getData515($bl_tanggal_awal, $bl_tanggal_akhir),
            ...
            'sum_target601' => $this->laporanFilterModel->sumTarget601(),
            //Menampilkan realisasi bulan lalu
            'sum_realisasi601' => $this->laporanFilterModel->sumRealisasi601($bl_tanggal_awal, $bl_tanggal_akhir),
            //Menampilkan realisasi bulan ini
            'bsum_realisasi601' => $this->laporanFilterModel->bsumRealisasi601($tanggal_awal, $tanggal_akhir),
            // Jenis Pajak 6 Opd 1
            'jenis_pendapatan601' => $this->laporanFilterModel->getJenis601(),
            // Menampilkan semua data jenis pajak 6 dan opd 1
            'laporan_perdinas601' => $this->laporanFilterModel->getData601($bl_tanggal_awal, $bl_tanggal_akhir),
            // ===========================================================================================
            // Lain-Lain Pendapatan Daerah yang Sah
            // Jenis pajak 7
            // 431
            ...
            'sum_target701' => $this->laporanFilterModel->sumTarget701(),
            //Menampilkan realisasi
            'sum_realisasi701' => $this->laporanFilterModel->sumRealisasi701($bl_tanggal_awal, $bl_tanggal_akhir),
            'bsum_realisasi701' => $this->laporanFilterModel->bsumRealisasi701($tanggal_awal, $tanggal_akhir),
            'jenis_pendapatan701' => $this->laporanFilterModel->getJenis701(),
            'laporan_perdinas701' => $this->laporanFilterModel->getData701($bl_tanggal_awal, $bl_tanggal_akhir),
            ...
            'sum_target801' => $this->laporanFilterModel->sumTarget801(),
            //Menampilkan realisasi bulan ini
            'sum_realisasi801' => $this->laporanFilterModel->sumRealisasi801($bl_tanggal_awal, $bl_tanggal_akhir),
            'bsum_realisasi801' => $this->laporanFilterModel->bsumRealisasi801($tanggal_awal, $tanggal_akhir),
            'jenis_pendapatan801' => $this->laporanFilterModel->getJenis801(),
            'laporan_perdinas801' => $this->laporanFilterModel->getData801($bl_tanggal_awal, $bl_tanggal_akhir),
            // ===========================================================================================
    ...
    public function filter2()
    {
        ...
        $data = [
            ...
            // Menampilkan semua data opd 2
            'laporan_perdinas2' => $this->laporanFilterModel->getData2($bl_tanggal_awal, $bl_tanggal_akhir),
            'bulan_ini2' => $this->laporanFilterModel->bulan_ini2($tanggal_awal, $tanggal_akhir),
        ...
        return view('laporan/filter2', $data);
    }
}
