...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Lain-Lain Pendapatan</li>
...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Lain-Lain Pendapatan Sesuai dengan Ketentuan Peraturan Perundang-undangan</h3>
        ...
        <div class="box-body">
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php $no = 1; ?>
                    <?php foreach ($lain_lain as $value) : ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('/lainLain/save'); ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <div class="box-body">
    ...
    <div class="modal fade" id="modal-edit<?= $value['id_realisasi']; ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('/lainLain/update/' . $value['id_realisasi']); ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="box-body">
