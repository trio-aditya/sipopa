...
<body>
    <table>
        ...
        <tr>
            <th colspan="9">
                ...
                <center>BERDASARKAN TARGET APBD SAMPAI DENGAN TANGGAL : <?= tgl_indo($tanggal_akhir); ?></center>
            </th>
        </tr>
        <tr>
            <th></th>
    ...
    <table class="table table-hover" border="1">
        ...
        <tr>
            ...
            ?>
            <th bgcolor='#FFA500' style='color:#FFFFFF'><?= number_format($persentase, 3, ',', '.'); ?></th>
...
<tr>
    ...
    ?>
    <th bgcolor='#708090' style='color:#FFFFFF'><?= number_format($persentase, 3, ',', '.'); ?></th>
...
<tr>
    ...
    <?php foreach ($laporan_perdinas512 as $value) : ?>
        ...
        $lk = $sd_bulan_ini - $value['target'];
        ?>
        <th bgcolor='#008000' style='color:#FFFFFF'><?= number_format($persen, 3, ',', '.'); ?></th>
...
<tr>
    ...
    <?php foreach ($laporan_perdinas701 as $value) : ?>
        ...
        $lk = $sd_bulan_ini - $value['target'];
        ?>
        <th bgcolor='#FF6347' style='color:#FFFFFF'><?= number_format($persen, 3, ',', '.'); ?></th>
...
<tr>
    ...
    $lebih_kurang = $sd_bulan_ini_jumlah - $target_jumlah;
    ?>
    <th bgcolor='#2F4F4F' style='color:#FFFFFF'><?= number_format($persentase, 3, ',', '.'); ?></th>
