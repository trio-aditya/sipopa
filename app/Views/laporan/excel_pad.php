...
header("Content-Disposition: attachment; filename=Laporan PAD.xls");
?>
<?php
error_reporting(0);
...
<body>
    <table>
        ...
        <tr>
            <th colspan="9">
                <center>TAHUN ANGGARAN : <?= tgl_indo(date('Y')); ?></center>
            </th>
        </tr>
        <tr>
            <th></th>
    ...
    <table class="table table-hover" border="1">
        ...
        <tr>
            ...
            <th bgcolor='#0000FF' style='color:#000000'></th>
            <th bgcolor='#0000FF' style='color:#000000'>PENDAPATAN DAERAH</th>
            <th bgcolor='#0000FF' style='color:#000000'><?= number_format($jumlah_target, 2, ',', '.'); ?></th>
            <th bgcolor='#0000FF' style='color:#000000'><?= number_format($jumlah_bulan_ini, 2, ',', '.'); ?></th>
            <th bgcolor='#0000FF' style='color:#000000'><?= number_format($jumlah_bulan_lalu, 2, ',', '.'); ?></th>
            <th bgcolor='#0000FF' style='color:#000000'><?= number_format($jumlah_sd_bulan_ini, 2, ',', '.'); ?></th>
            <th bgcolor='#0000FF' style='color:#000000'><?= number_format($jumlah_persentase, 3, ',', '.'); ?></th>
            <th bgcolor='#0000FF' style='color:#000000'><?= number_format($jumlah_lebih_kurang, 2, ',', '.'); ?></th>
        </tr>
        <tr>
        ...
        <?php foreach ($jenis_pendapatan1 as $value) : ?>
            <tr>
                <th bgcolor='#00FF00' style='color:#000000' colspan="3">1. PENDAPATAN <?= $value['jenis_pajak']; ?></th>
                <th bgcolor='#00FF00' style='color:#000000'><?= number_format($pd, 2, ',', '.'); ?></th>
                <!-- Realisasi dengan jenis pajak 1 -->
            ...
            <tr>
                ...
                <th><?= number_format($persentase, 3, ',', '.'); ?></th>
    ...
    <?php foreach ($jenis_pendapatan2 as $value) : ?>
        <tr>
            <th bgcolor='#FFFF00' style='color:#000000'></th>
            <th bgcolor='#FFFF00' style='color:#000000'><?= $value['kode']; ?></th>
            <th th bgcolor='#FFFF00' style='color:#000000'>HASIL <?= $value['jenis_pajak']; ?></th>
            <th bgcolor='#FFFF00' style='color:#000000'><?= number_format($retribusi, 2, ',', '.'); ?></th>
            <th bgcolor='#FFFF00' style='color:#000000'><?= number_format($retribusi_bulan_ini, 2, ',', '.'); ?></th>
            <th bgcolor='#FFFF00' style='color:#000000'><?= number_format($retribusi_bulan_lalu, 2, ',', '.'); ?></th>
            <th bgcolor='#FFFF00' style='color:#000000'><?= number_format($retribusi_sd_bulan_ini, 2, ',', '.'); ?></th>
            <th bgcolor='#FFFF00' style='color:#000000'><?= number_format($retribusi_persentase, 3, ',', '.'); ?></th>
            <th bgcolor='#FFFF00' style='color:#000000'><?= number_format($retribusi_lebih_kurang, 2, ',', '.'); ?></th>
        </tr>
        <tr>
            <th bgcolor='#00FF00' style='color:000000'></th>
            <th bgcolor='#00FF00' style='color:000000'><?= $value['kode']; ?> 01</th>
            <th bgcolor='#00FF00' style='color:000000'>Retribusi Jasa Umum</th>
            <th bgcolor='#00FF00' style='color:000000'><?= number_format($jum_target, 2, ',', '.'); ?></th>
            <th bgcolor='#00FF00' style='color:000000'><?= number_format($jum_bulan_ini, 2, ',', '.'); ?></th>
            <th bgcolor='#00FF00' style='color:000000'><?= number_format($jum_bulan_lalu, 2, ',', '.'); ?></th>
            <th bgcolor='#00FF00' style='color:000000'><?= number_format($jum_sd_bulan_ini, 2, ',', '.'); ?></th>
            <th bgcolor='#00FF00' style='color:000000'><?= number_format($jum_persentase, 3, ',', '.'); ?></th>
            <th bgcolor='#00FF00' style='color:000000'><?= number_format($jum_lebih_kurang, 2, ',', '.'); ?></th>
        </tr>
    <?php endforeach; ?>
    <tr>
    ...
    <tr>
        ...
        <?php foreach ($jasa_umum as $value) : ?>
            ...
            <!-- Menampilkan data bulan sekarang -->
            <?php $bln = !empty($this->laporanModel->getRetribusi($bulan)[$i3]) ? number_format($this->laporanModel->getRetribusi($bulan)[$i3]['realisasi'], 2, ',', '.') : '0'; ?>
            <!-- Menampilkan data bulan lalu -->
            <?php $bln_lalu = !empty($this->laporanModel->retribusi_bulan_lalu($bulan_lalu)[$i3]) ? number_format($this->laporanModel->retribusi_bulan_lalu($bulan_lalu)[$i3]['realisasi'], 2, ',', '.') : '0'; ?>
            <td><?= $bln  ?></td>
            <td><?= $bln_lalu; ?></td>
            <!-- S/D Bulan ini didapat dari penjumlahan Bulan ini + Bulan lalu -->
            <?php $sampai_dengan = ($bln + $bln_lalu) * 1000; ?>
...
<tr>
    ...
    <?php foreach ($b_rju5 as $value) : ?>
        ...
        <!-- Menampilkan data bulan sekarang -->
        <?php $bln = !empty($this->laporanModel->b_rju5($bulan)[$rju5]) ? number_format($this->laporanModel->b_rju5($bulan)[$rju5]['realisasi'], 2, ',', '.') : '0'; ?>
        <!-- Menampilkan data bulan lalu -->
        <?php $bln_lalu = !empty($this->laporanModel->bl_rju5($bulan_lalu)[$rju5]) ? number_format($this->laporanModel->bl_rju5($bulan_lalu)[$rju5]['realisasi'], 2, ',', '.') : '0'; ?>
        <td><?= $bln  ?></td>
        <td><?= $bln_lalu; ?></td>
        <!-- S/D Bulan ini didapat dari penjumlahan Bulan ini + Bulan lalu -->
        <?php $sampai_dengan = ($bln + $bln_lalu) * 1000; ?>
...
<tr>
    ...
    <?php foreach ($b_rju8 as $value) : ?>
        ...
        <!-- Menampilkan data bulan sekarang -->
        <?php $bln = !empty($this->laporanModel->b_rju8($bulan)[$rju8]) ? number_format($this->laporanModel->b_rju8($bulan)[$rju8]['realisasi'], 2, ',', '.') : '0'; ?>
        <!-- Menampilkan data bulan lalu -->
        <?php $bln_lalu = !empty($this->laporanModel->bl_rju8($bulan_lalu)[$rju8]) ? number_format($this->laporanModel->bl_rju8($bulan_lalu)[$rju8]['realisasi'], 2, ',', '.') : '0'; ?>
        <td><?= $bln  ?></td>
        <td><?= $bln_lalu; ?></td>
        <!-- S/D Bulan ini didapat dari penjumlahan Bulan ini + Bulan lalu -->
        <?php $sampai_dengan = ($bln + $bln_lalu) * 1000; ?>
...
<tr>
    <th bgcolor='#00FF00' style='color:000000'></th>
    <th bgcolor='#00FF00' style='color:000000'><?= $value['kode']; ?> 02</th>
    <th bgcolor='#00FF00' style='color:000000'>Retribusi Jasa Usaha</th>
    <th bgcolor='#00FF00' style='color:000000'><?= number_format($ju_target, 2, ',', '.'); ?></th>
    <th bgcolor='#00FF00' style='color:000000'><?= number_format($ju_bulan_ini, 2, ',', '.'); ?></th>
    <th bgcolor='#00FF00' style='color:000000'><?= number_format($ju_bulan_lalu, 2, ',', '.'); ?></th>
    <th bgcolor='#00FF00' style='color:000000'><?= number_format($ju_sd_bulan_ini, 2, ',', '.'); ?></th>
    <th bgcolor='#00FF00' style='color:000000'><?= number_format($ju_persentase, 3, ',', '.'); ?></th>
    <th bgcolor='#00FF00' style='color:000000'><?= number_format($ju_lebih_kurang, 2, ',', '.'); ?></th>
<tr>
    ...
    <td><?= number_format($rpkd_persentase, 3, ',', '.'); ?></td>
...
<tr>
    ...
    <?php foreach ($jasa_usaha as $value) : ?>
        <?php if ($value['kode_rekening'] != '0201' && $value['kode_rekening'] != '0211') : ?>
            ...
            <td><?= number_format($value['target'], 2, ',', '.'); ?></td>
            <!-- Menampilkan data bulan sekarang -->
            <?php $bln = !empty($this->laporanModel->getRetribusi2($bulan)[$ia]) ? number_format($this->laporanModel->getRetribusi2($bulan)[$ia]['realisasi'], 2, ',', '.') : '0'; ?>
            <!-- Menampilkan data bulan lalu -->
            <?php $bln_lalu = !empty($this->laporanModel->retribusi_bulan_lalu2($bulan_lalu)[$ia]) ? number_format($this->laporanModel->retribusi_bulan_lalu2($bulan_lalu)[$ia]['realisasi'], 2, ',', '.') : '0'; ?>
            <td><?= $bln  ?></td>
            <td><?= $bln_lalu  ?></td>
            <!-- S/D Bulan ini didapat dari penjumlahan Bulan ini + Bulan lalu -->
            <?php $sampai_dengan = ($bln + $bln_lalu) * 1000; ?>
...
<tr>
    ...
    <?php foreach ($b_rjus3 as $value) : ?>
        ...
        <!-- Menampilkan data bulan sekarang -->
        <?php $bln = !empty($this->laporanModel->b_rjus3($bulan)[$rjus3]) ? number_format($this->laporanModel->b_rjus3($bulan)[$rjus3]['realisasi'], 2, ',', '.') : '0'; ?>
        <!-- Menampilkan data bulan lalu -->
        <?php $bln_lalu = !empty($this->laporanModel->bl_rjus3($bulan_lalu)[$rjus3]) ? number_format($this->laporanModel->bl_rjus3($bulan_lalu)[$rjus3]['realisasi'], 2, ',', '.') : '0'; ?>
        <td><?= $bln  ?></td>
        <td><?= $bln_lalu; ?></td>
        <!-- S/D Bulan ini didapat dari penjumlahan Bulan ini + Bulan lalu -->
        <?php $sampai_dengan = ($bln + $bln_lalu) * 1000; ?>
...
<tr>
    ...
    <td><?= number_format($ppud_persentase, 3, ',', '.'); ?></td>
    <td><?= number_format($ppud_lebih_kurang, 2, ',', '.'); ?></td>
</tr>

<tr>
    <th bgcolor='#00FF00' style='color:000000'></th>
    <th bgcolor='#00FF00' style='color:000000'><?= $value['kode']; ?> 03</th>
    <th bgcolor='#00FF00' style='color:000000'>Retribusi Perizinan Tertentu</th>
    <th bgcolor='#00FF00' style='color:000000'><?= number_format($rpt_target, 2, ',', '.'); ?></th>
    <th bgcolor='#00FF00' style='color:000000'><?= number_format($rpt_bulan_ini, 2, ',', '.'); ?></th>
    <th bgcolor='#00FF00' style='color:000000'><?= number_format($rpt_bulan_lalu, 2, ',', '.'); ?></th>
    <th bgcolor='#00FF00' style='color:000000'><?= number_format($rpt_sd_bulan_ini, 2, ',', '.'); ?></th>
    <th bgcolor='#00FF00' style='color:000000'><?= number_format($rpt_persentase, 2, ',', '.'); ?></th>
    <th bgcolor='#00FF00' style='color:000000'><?= number_format($rpt_lebih_kurang, 2, ',', '.'); ?></th>
</tr>
<tr>
    <?php $no = 1;
    $i = 0;
    ...
    <?php foreach ($perizinan_tertentu as $value) : ?>
        <?php if ($value['kode_rekening'] != '01010001') : ?>
            ...
            <td><?= number_format($value['target'], 2, ',', '.'); ?></td>
            <!-- Menampilkan data bulan sekarang -->
            <?php $bln = !empty($this->laporanModel->getRetribusi3($bulan)[$i]) ? number_format($this->laporanModel->getRetribusi3($bulan)[$i]['realisasi'], 2, ',', '.') : '0'; ?>
            <!-- Menampilkan data bulan lalu -->
            <?php $bln_lalu = !empty($this->laporanModel->retribusi_bulan_lalu3($bulan_lalu)[$i]) ? number_format($this->laporanModel->retribusi_bulan_lalu3($bulan_lalu)[$i]['realisasi'], 2, ',', '.') : '0'; ?>
            <td><?= $bln  ?></td>
            <td><?= $bln_lalu; ?></td>
            <!-- S/D Bulan ini didapat dari penjumlahan Bulan ini + Bulan lalu -->
            <?php $sampai_dengan = ($bln + $bln_lalu) * 1000; ?>
...
<?php foreach ($jenis_pendapatan13 as $value) : ?>
    <tr>
        <th bgcolor='#FFFF00' style='color:#000000'></th>
        <th bgcolor='#FFFF00' style='color:#000000'><?= $value['kode']; ?></th>
        <th th bgcolor='#FFFF00' style='color:#000000'><?= $value['jenis_pajak']; ?></th>
        <th bgcolor='#FFFF00' style='color:#000000'><?= number_format($hpkdd, 2, ',', '.'); ?></th>
        <th bgcolor='#FFFF00' style='color:#000000'><?= number_format($hpkdd_bulan_ini, 2, ',', '.'); ?></th>
        <th bgcolor='#FFFF00' style='color:#000000'><?= number_format($hpkdd_bulan_lalu, 2, ',', '.'); ?></th>
        <th bgcolor='#FFFF00' style='color:#000000'><?= number_format($hpkdd_sd_bulan_ini, 2, ',', '.'); ?></th>
        <th bgcolor='#FFFF00' style='color:#000000'><?= number_format($hpkdd_persentase, 3, ',', '.'); ?></th>
        <th bgcolor='#FFFF00' style='color:#000000'><?= number_format($hpkdd_lebih_kurang, 2, ',', '.'); ?></th>
    <tr>
        <td align="center">1</td>
        <td><?= $value['kode']; ?></td>
...
<?php foreach ($jenis_pendapatan15 as $value) : ?>
    <tr>
        ...
        <th bgcolor='#FFFF00' style='color:#000000'><?= $value['kode']; ?></th>
        <th th bgcolor='#FFFF00' style='color:#000000'><?= $value['jenis_pajak']; ?></th>
        <th bgcolor='#FFFF00' style='color:#000000'><?= number_format($lain_lain, 2, ',', '.'); ?></th>
        <th bgcolor='#FFFF00' style='color:#000000'><?= number_format($lain_lain_bulan_ini, 2, ',', '.'); ?></th>
        <th bgcolor='#FFFF00' style='color:#000000'><?= number_format($lain_lain_bulan_lalu, 2, ',', '.'); ?></th>
        <th bgcolor='#FFFF00' style='color:#000000'><?= number_format($lain_lain_sd_bulan_ini, 2, ',', '.'); ?></th>
        <th bgcolor='#FFFF00' style='color:#000000'><?= number_format($lain_lain_persentase, 3, ',', '.'); ?></th>
        <th bgcolor='#FFFF00' style='color:#000000'><?= number_format($lain_lain_lebih_kurang, 2, ',', '.'); ?></th>
    <tr>
