        ...
        <div class="box-header">
            ...
            <div class="btn-toolbar pull-right" role="toolbar" aria-label="Toolbar with button groups">
                <div class="btn-group mr-2" role="group" aria-label="First group">
                    <a href="<?= base_url('/realisasi/excel'); ?>" class="btn btn-primary btn-sm" role="button" aria-disabled="true"><i class="fa fa-file-excel-o"></i> EXCEL</a>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('/realisasi/save'); ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <div class="box-body">
    ...
    <div class="modal fade" id="modal-edit<?= $value['id_realisasi']; ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('/realisasi/update/' . $value['id_realisasi']); ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="box-body">
