...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Dana Insentif Daerah (DID)</li>
...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Dana Insentif Daerah (DID)</h3>
        ...
        <div class="box-body">
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php $no = 1; ?>
                    <?php foreach ($dana_insentif_daerah as $value) : ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('/danaInsentifDaerah/save'); ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <div class="box-body">
...
<!-- Start Edit Data -->
<?php $no = 0;
foreach ($dana_insentif_daerah as $value) : $no++ ?>
    <div class="modal fade" id="modal-edit<?= $value['id_realisasi']; ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('/danaInsentifDaerah/update/' . $value['id_realisasi']); ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="box-body">
